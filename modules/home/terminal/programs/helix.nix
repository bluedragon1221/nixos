{
  ...
  options = {
    collinux.terminal.programs.helix = {
      enable = lib.mkEnableOption "the helix text editor";
      hardMode = lib.mkOption {
        type = lib.types.bool;
        description = "Disables arrow keys and mouse";
        default = false;
      };
    };
  };
