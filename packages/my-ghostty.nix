{
  ...
  # shaders = builtins.fetchGit {
  #   url = "https://github.com/m-ahdal/ghostty-shaders";
  #   rev = "fd31bd4211784f1e199091bccd080092ae27cf35";
  # };
  glsl_bloom = pkgs.writeText "glsl-bloom" ''
...
in
  cfgWrapper {
    ...
    binName = "ghostty";
    extraFlags = ["--config-file=${ghostty-config}"];
    extraEnv.XCURSOR_THEME = "Vanilla-DMZ";
  }
